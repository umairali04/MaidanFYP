...
export default function OwnerGroundAnalytics({
  groundId,
}) {
  ...
  const growthPositive = bookingGrowth >= 0;
    ...
    <section className="bg-white rounded-2xl border border-gray-100 p-5 sm:p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-400 text-sm">
          Owner performance and booking overview
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <div className="rounded-2xl bg-green-50 border border-green-100 p-4">
          ...
          <p className="text-green-600 font-bold text-xl sm:text-2xl break-words">
