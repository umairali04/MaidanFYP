            ...
            >
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-400">
                  {grounds.length}{" "}
                  {grounds.length === 1 ? "ground" : "grounds"} found
                  {search ? ` in ${search}` : ""}
                </p>
          ...
          {loading ? (
            ...
            >
              ...
              <p className="mt-2 max-w-sm text-sm leading-6 text-slate-400">
                We couldn't find any grounds matching your search.
                Try another city or explore all available grounds.
              </p>
              ...
              {grounds.map((ground) => (
                ...
                <div
                  ...
                  className="
                    ...
                    hover:-translate-y-1
                    hover:border-emerald-200
                    hover:shadow-[0_18px_45px_rgba(16,185,129,0.12)]
                  "
                >
        ...
        >
          ...
          >
            ...
            <div className="p-5 sm:p-7">
              ...
              >
                ...
                <div className="rounded-xl bg-slate-50 p-3 text-center">
                  ...
                  <p className="mt-1 text-xs font-bold text-slate-800">
                    {selectedGround.openTime} –{" "}
                    {selectedGround.closeTime}
                  </p>
              ...
              <button
                onClick={(e) =>
                  handleBookNow(e, selectedGround.id)
                }
                className="
                  mt-6
                  w-full
